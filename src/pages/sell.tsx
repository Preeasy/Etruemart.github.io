      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2">
            <form onSubmit={handleSubmit} className="bg-gray-50 rounded-2xl shadow-lg p-8 space-y-6 border border-dark-500/20">
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-dark-700 border border-dark-500/30 rounded-lg focus:outline-none focus:ring-2 focus:ring-gold-500/50 text-gray-900"
                ...
                <div>
                  ...
                  {isCategoryLocked && (
                    <p className="mt-1 text-xs text-gray-500">Your account is restricted to a specific category</p>
                  )}
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-3 gap-6">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-600 mb-2">Original Price (Optional)</label>
                  <div className="relative">
                    <DollarSign className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-500" />
                    <input
                      type="number"
              ...
              <div className="grid md:grid-cols-3 gap-6">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-600 mb-2">Plating</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-600 mb-2">Process</label>
                  <input
                    type="text"
              ...
              <div className="grid md:grid-cols-3 gap-6">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-600 mb-2">Pack Size</label>
                  <input
                    type="number"
              ...
              <div className="grid md:grid-cols-4 gap-6">
                <div>
                  <label className="block text-sm font-medium text-gray-600 mb-2">Pkg Length (cm)</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-600 mb-2">Pkg Width (cm)</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-600 mb-2">Pkg Height (cm)</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-600 mb-2">Pkg Weight (g)</label>
                  <input
                    type="number"
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div>
                  <label className="block text-sm font-medium text-gray-600 mb-2">MOQ</label>
                  <input
                    type="number"
                    value={formData.moq}
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-600 mb-2">Keywords (comma separated)</label>
                  <input
                    type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-600 mb-2">Main Image URL</label>
                <div className="relative">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-600 mb-2">Variants (Optional)</label>
                    ...
                    <div key={index} className="grid grid-cols-2 md:grid-cols-4 gap-4 p-4 bg-dark-700/50 rounded-lg border border-dark-500/20">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-3 py-2 bg-dark-700 border border-dark-500/30 rounded-lg text-sm text-gray-900"
                ...
                <button
                  type="button"
                  onClick={addVariant}
                  className="mt-3 flex items-center gap-2 text-gold-500 hover:text-gold-500 text-sm font-medium"
                >
              ...
              <div className="flex gap-4 pt-4">
                <button
                  type="submit"
                  className="flex-1 bg-gold-500 hover:bg-gold-400 text-white font-bold py-3 rounded-lg transition-colors"
                >
                  Publish Product
                </button>
                <button
                  ...
                  className="px-6 py-3 border border-dark-500/30 text-gray-600 font-semibold rounded-lg hover:bg-dark-700 transition-colors"
                >
                  Cancel
                </button>
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-50 rounded-2xl p-6 shadow-lg border border-dark-500/20">
