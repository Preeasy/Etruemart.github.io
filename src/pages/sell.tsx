          ...
          <div className="lg:col-span-2">
            <form onSubmit={handleSubmit} className="bg-gray-50 rounded-2xl shadow-lg p-8 space-y-6 border border-gray-300/20">
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-gray-100 border border-gray-300/30 rounded-lg focus:outline-none focus:ring-2 focus:ring-gold-500/50 text-gray-900"
              ...
              <div className="grid md:grid-cols-4 gap-6">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Pkg Length (cm)</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Pkg Width (cm)</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Pkg Height (cm)</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Pkg Weight (g)</label>
                  <input
                    type="number"
              ...
              <div>
                ...
                <div className="space-y-4">
                  {formData.variants.map((variant, index) => (
                    <div key={index} className="grid grid-cols-2 md:grid-cols-4 gap-4 p-4 bg-gray-100/50 rounded-lg border border-gray-300/20">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-3 py-2 bg-gray-100 border border-gray-300/30 rounded-lg text-sm text-gray-900"
                ...
                <button
                  type="button"
                  onClick={addVariant}
                  className="mt-3 flex items-center gap-2 text-gold-600 hover:text-gold-600 text-sm font-medium"
                >
              ...
              <div className="flex gap-4 pt-4">
                ...
                <button
                  ...
                  className="px-6 py-3 border border-gray-300/30 text-gray-700 font-semibold rounded-lg hover:bg-gray-100 transition-colors"
                >
                  Cancel
                </button>
              </div>
            ...
            <div className="bg-gray-50 rounded-2xl p-6 border border-gray-300/20">
              ...
              <ul className="space-y-3 text-sm text-gray-500">
                <li className="flex items-start gap-2">
                  <ChevronRight className="w-5 h-5 text-gold-600 flex-shrink-0" />
