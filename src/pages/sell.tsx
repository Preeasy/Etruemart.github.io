    ...
    <Layout>
      ...
      <div className="bg-ink-50 border-b border-ink-200/30">
        <div className="w-full px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 max-w-[1600px] mx-auto py-8">
          <h1 className="text-3xl font-bold text-navy-900">List a New Product</h1>
          <p className="text-ink-500 mt-1">Start selling to customers worldwide</p>
        </div>
      </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
            ...
            <form onSubmit={handleSubmit} className="bg-ink-50 rounded-xl p-8 space-y-6 border border-ink-200/20">
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  {isCategoryLocked && (
                    <p className="mt-1 text-xs text-ink-500">Your account is restricted to a specific category</p>
                  )}
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div>
                  <label className="block text-sm font-medium text-ink-700 mb-2">Price</label>
                ...
                <div>
                  <label className="block text-sm font-medium text-ink-700 mb-2">Original Price (Optional)</label>
                  <div className="relative">
                    <DollarSign className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-ink-500" />
                    <input
                      type="number"
                ...
                <div>
                  <label className="block text-sm font-medium text-ink-700 mb-2">Stock Quantity</label>
                  <input
                    type="number"
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div>
                  <label className="block text-sm font-medium text-ink-700 mb-2">Material</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-sm font-medium text-ink-700 mb-2">Plating</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-sm font-medium text-ink-700 mb-2">Process</label>
                  <input
                    type="text"
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div>
                  <label className="block text-sm font-medium text-ink-700 mb-2">Color</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-sm font-medium text-ink-700 mb-2">Size</label>
                  <input
                    type="text"
                    value={formData.size}
                ...
                <div>
                  <label className="block text-sm font-medium text-ink-700 mb-2">Pack Size</label>
                  <input
                    type="number"
              ...
              <div className="grid md:grid-cols-4 gap-6">
                <div>
                  <label className="block text-sm font-medium text-ink-700 mb-2">Pkg Length (cm)</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block text-sm font-medium text-ink-700 mb-2">Pkg Width (cm)</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block text-sm font-medium text-ink-700 mb-2">Pkg Height (cm)</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block text-sm font-medium text-ink-700 mb-2">Pkg Weight (g)</label>
                  <input
                    type="number"
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div>
                  <label className="block text-sm font-medium text-ink-700 mb-2">MOQ</label>
                  <input
                    type="number"
                    value={formData.moq}
                ...
                <div>
                  <label className="block text-sm font-medium text-ink-700 mb-2">Keywords (comma separated)</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-sm font-medium text-ink-700 mb-2">Stock Status</label>
                  <select
              ...
              <div>
                <label className="block text-sm font-medium text-ink-700 mb-2">Main Image URL</label>
                <div className="relative">
                ...
                <p className="mt-1 text-xs text-ink-500">Use an image URL from Unsplash or your hosting</p>
              </div>

              <div>
                <label className="block text-sm font-medium text-ink-700 mb-2">Variants (Optional)</label>
                <div className="space-y-4">
                  {formData.variants.map((variant, index) => (
                    <div key={index} className="grid grid-cols-2 md:grid-cols-4 gap-4 p-4 bg-ink-100/50 rounded-lg border border-ink-200/20">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-3 py-2 bg-ink-100 border border-ink-200/30 rounded-lg text-sm text-navy-900"
                      ...
                      <div>
                        <label className="block text-xs font-medium text-ink-500 mb-1">Price</label>
                        <input
                          type="number"
                          value={variant.price}
                      ...
                      <div>
                        <label className="block text-xs font-medium text-ink-500 mb-1">Stock</label>
                        <input
                          type="number"
                          value={variant.stock}
                ...
                <button
                  type="button"
                  onClick={addVariant}
                  className="mt-3 flex items-center gap-2 text-accent-600 hover:text-accent-600 text-sm font-medium"
                >
          ...
          <div className="space-y-6">
            <div className="bg-ink-50 rounded-xl p-6 border border-ink-200/20">
              <h3 className="font-semibold text-navy-900 mb-4">Selling Tips</h3>
            ...
            <div className="bg-ink-50 rounded-xl p-6 border border-ink-200/20">
              <h3 className="font-semibold text-navy-900 mb-4">Ready to Sell?</h3>
