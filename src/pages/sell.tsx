            ...
            <form onSubmit={handleSubmit} className="bg-dark-800 rounded-2xl shadow-lg p-8 space-y-6 border border-dark-500/20">
              ...
              <div>
                ...
                <button
                  type="button"
                  onClick={addVariant}
                  className="mt-3 flex items-center gap-2 text-accent-500 hover:text-accent-400 text-sm font-medium"
                >
              ...
              <div className="flex gap-4 pt-4">
                <button
                  type="submit"
                  className="flex-1 bg-accent-500 hover:bg-accent-400 text-dark-900 font-bold py-3 rounded-lg transition-colors"
                >
                  Publish Product
                </button>
                <button
