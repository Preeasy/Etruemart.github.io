        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex gap-3">
              ...
              <Link
                href="/products"
                className="inline-flex items-center gap-2 border-2 border-primary-500 text-primary-400 hover:bg-primary-500 hover:text-dark-900 px-6 py-3 rounded-lg font-bold transition-colors"
              >
                Request Catalog
              </Link>
            </div>
      ...
      <div className="border-t border-dark-700/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
            ...
            {/* Categories */}
            <div>
              <h4 className="font-semibold text-sm text-primary-400 uppercase tracking-wider mb-4">
                Categories
              </h4>
              <ul className="space-y-2.5 text-dark-400 text-sm">
                <li><Link href="/products?category=fashion-jewelry" className="hover:text-primary-400 transition-colors">Fashion Jewelry</Link></li>
                <li><Link href="/products?category=garment-accessories" className="hover:text-primary-400 transition-colors">Garment Accessories</Link></li>
                <li><Link href="/products?category=hair-accessories" className="hover:text-primary-400 transition-colors">Hair Accessories</Link></li>
                ...
                <li><Link href="/products?category=home-decor-crafts" className="hover:text-primary-400 transition-colors">Home Decor & Crafts</Link></li>
                <li><Link href="/products?category=seasonal-festival" className="hover:text-primary-400 transition-colors">Seasonal & Festival</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2.5 text-dark-400 text-sm">
                ...
                <li><Link href="/sell" className="hover:text-primary-400 transition-colors">Sell on YEATRU</Link></li>
                <li><a href="#" className="hover:text-primary-400 transition-colors">About Us</a></li>
                <li><a href="#" className="hover:text-primary-400 transition-colors">Sourcing Services</a></li>
                <li><a href="#" className="hover:text-primary-400 transition-colors">Quality Assurance</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-dark-400 text-sm">
                <li className="flex items-center gap-2.5">
                  ...
                  <a href="mailto:info@yeatru.com" className="hover:text-primary-400 transition-colors">info@yeatru.com</a>
                </li>
                <li className="flex items-center gap-2.5">
              ...
              <div className="mt-5">
                ...
                <div className="flex">
                  <input
                    ...
                    className="flex-1 min-w-0 px-3 py-2 bg-dark-800 border border-dark-600/50 rounded-l-lg text-sm text-dark-200 placeholder-dark-500 focus:outline-none focus:ring-1 focus:ring-primary-500/50"
                  />
                  <button className="bg-primary-500 hover:bg-primary-400 text-dark-900 px-3 py-2 rounded-r-lg transition-colors">
